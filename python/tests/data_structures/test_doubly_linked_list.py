...
def test_prepend(elements: Iterable) -> None:
...
def test_extend(it: Iterable) -> None:
    lst = DoublyLinkedList()
    seq = tuple(it)
...
def test_contains(it: Iterable, value: int, answer: bool) -> None:
...
def test_reversing(it: list) -> None:
    icopy = it.copy()
...
def test_copy(it: Iterable) -> None:
    dlist = DoublyLinkedList(it)
...
def test_add(it1: list, it2: list) -> None:
...
def test_mul(lst: list, nbr: int) -> None:
...
def test_extendleft(list1: list, list2: list) -> None:
